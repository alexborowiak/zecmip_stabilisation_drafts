...
MODEL_PROFILES = {'longrunmip': constants.LONGRUNMIP_MODEL_PARAMS, 'zecmip': constants.ZECMIP_MODEL_PARAMS, 'region': REGION_STYLE_DICT}
...
def plot_all_coord_lines(da: xr.DataArray, coord='model', exp_type=None,
                         ...
                         increment:int=10, linestyle='-', colors:Union[str, Tuple, Dict]=None, logginglevel='ERROR',
                        **kwargs):
    '''
    ...
    for i, coord_value in enumerate(coord_values):
        ...
        if exp_type:
            ...
            if 'linewidth' in params[coord_value]: linewidth = params[coord_value]['linewidth']
